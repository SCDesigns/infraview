<head>
  ...
  <title>Generator Bus Bar Thermometer | Contact</title>
  				...
  				<tr>
  					...
  					<td valign="top">
  						<div align="left">
  							...
  							<br/>
                <div align="left">
  			         <label for="use-other">Other: </label><input type="text" class="input-text"name="use-other" maxlength="30" size="30" value="" placeholder="">
               </div>
              </div>
  					</td>
  				</tr>
